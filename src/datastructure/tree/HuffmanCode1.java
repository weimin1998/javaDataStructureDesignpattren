...
public class HuffmanCode1 {
    ...
    public static byte[] huffmanZip(String file) throws Exception {
        List<Node> nodeList = getNodeList(file);
     ...
     * @throws Exception 异常
     */
    private static List<Node> getNodeList(String file) throws Exception {
    ...
    private static byte[] unzip(byte[] zip, Map<Byte,String> huffmanTable){
        StringBuilder stringBuilder = new StringBuilder();
